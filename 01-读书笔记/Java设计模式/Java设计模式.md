...
![[Java设计模式 (刘伟) (Z-Library).pdf#page=393&rect=150,269,1296,638|Java设计模式 (刘伟) (Z-Library), p.393]]
![[Java设计模式 (刘伟) (Z-Library).pdf#page=394&rect=165,699,1286,1592|Java设计模式 (刘伟) (Z-Library), p.394]]

### 26.5.3 访问者模式适用环境
![[Java设计模式 (刘伟) (Z-Library).pdf#page=406&rect=147,518,1294,921|Java设计模式 (刘伟) (Z-Library), p.406]]

## 26.6 本章小结
![[Java设计模式 (刘伟) (Z-Library).pdf#page=406&rect=144,169,1299,386|Java设计模式 (刘伟) (Z-Library), p.406]]
![[Java设计模式 (刘伟) (Z-Library).pdf#page=407&rect=150,1166,1298,1858|Java设计模式 (刘伟) (Z-Library), p.407]]
